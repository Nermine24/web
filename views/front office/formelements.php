		...
		<div id="app" class="page">
			<div class="main-wrapper" >
				...
				<div class="app-content">
                   ...
                   <form method="GET" action="ajouter_personne.php">

								<div class="card">										
									
											<div class="card-body">
										<form m class="form-horizontal" >
							...
							<input class="form-control" type="text" name="nom" onblur="verifnom(this);">
                               		...
                               		<div class="form-group row">
												<label class="col-md-3 col-form-label" placeholder="numéro Tel">Tel</label>
												<div class="col-md-9">
													<input class="form-control" type="tel" name="tel" onblur="veriftel(this);">
												</div>
											</div>
											<div class="form-group row mb-0">
												<label class="col-md-3 col-form-label">Type de permis</label>
												<div class="col-md-9">
				...
				<div class="popup-box chat-popup" id="qnimate">
					<div class="popup-head">
						...
						<div class="popup-head-right pull-right">
							<div class="btn-group">
								<button class="chat-header-button" data-toggle="dropdown" type="button" aria-expanded="false"  onaction="verif()">
